    ...
    <section id="contact" className="py-16 px-6 bg-[#F5F5F5]">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="w-[500px]">
          ...
          <form onSubmit={handleSubmit} className="bg-[#E4E4E4] p-6 rounded-b-2xl space-y-6 flex flex-col justify-center items-center">
            <Input
              type="text"
              name="fullName"
            ...
            <Button
              type="submit"
              className="w-36 bg-[#31312f] hover:bg-[#C8C8C8] text-[#F5F5F5] py-3 text-lg font-medium cursor-pointer">
              Submit
            </Button>
          </form>
        </div>
